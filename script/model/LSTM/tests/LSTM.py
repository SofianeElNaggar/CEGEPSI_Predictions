# -*- coding: utf-8 -*-
"""
Version : même pipeline, exécution unique sur la combinaison présente dans ALL_TARGETS
(génère un PDF pour cette combinaison).
"""
import os
...
OUTPUT_PDF_TEMPLATE = f"../../../results/prediction/LSTM/v4.1/{AGG_METHOD}/LSTM_predictions_bis_{AGG_METHOD}__{{names}}.pdf"
