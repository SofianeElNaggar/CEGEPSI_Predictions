...
def analyze_temperature_simple():
    # Configuration
    ...
    output_img = "results/plots/temperature_simple_analysis.png"
    ...
    # Original Signal
    plt.plot(daily_df.index, values, color='black', label='Temperature')
    plt.title(f"Temperature (Depth {depth_target}m) - {start_date} to {end_date}")
    plt.ylabel('Temp (°C)')
